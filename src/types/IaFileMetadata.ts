import { IaFileRotation, IaFileSource, StringOrStringArray } from ".";

export type IaFileMetadataRaw<T extends IaFileBaseMetadata = IaFileBaseMetadata> = {
